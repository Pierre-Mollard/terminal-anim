...
int main(int argc, char *argv[]) {
  ...
  tau_put_filled_rectangle(ctx, 50, 10, 10, 10, 'R', fg_style);
  tau_put_rectangle(ctx, 10, 10, 10, 10, 'R', fg_style);
